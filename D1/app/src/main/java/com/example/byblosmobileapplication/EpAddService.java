...
public class EpAddService extends AppCompatActivity {
    ...
    public void addService(View  view){
        databaseEmServices=FirebaseDatabase.getInstance().getReference("EmService");
    ...
    private void deleteService(String serviceName){
        ...
        DatabaseReference dService = FirebaseDatabase.getInstance().getReference("EmService").child(serviceName);
